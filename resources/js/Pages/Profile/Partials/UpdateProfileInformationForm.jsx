                    ...
                    <div>
                        <p className="mt-2 text-sm text-gray-800 dark:text-gray-200">
                            ...
                            <Link
                                ...
                                method="post"
                                as="button"
                                className="ms-2 rounded-md text-sm text-gray-600 dark:text-gray-400 underline hover:text-gray-900 dark:hover:text-gray-100 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-red-500 dark:focus:ring-offset-gray-800"
                            >
